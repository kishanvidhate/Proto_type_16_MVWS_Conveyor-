...
function renderInputs(st=null) {
  ...
  if (!lhsInput && lhsFormula) { const fake = {address: lhsFormula.address, label: lhsFormula.label}; const input = buildInput(advDiv, fake); input.value = to2(current[fake.address]); }
}
